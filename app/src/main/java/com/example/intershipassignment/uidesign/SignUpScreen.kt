...
fun CreateAccountScreen(modifier: Modifier = Modifier, navController: NavHostController) {
    ...
    var justify by remember { mutableStateOf(false) }
    ...
    Column(
        ...
        OutlinedTextField(
            ...
            label = { Text("Email (proper email id)") },
        ...
        OutlinedTextField(
            ...
            label = { Text("Password (atleat 8 minimum characters)") },
            modifier = Modifier.fillMaxWidth(),
            textStyle = TextStyle(color = Color.Black),
        ...
        if (showErrorDialog) {
            AlertDialog(
                ...
                title = { Text("Error") },
                text = { Text("Passwords do not match or does not meet the credential criteria") },
                confirmButton = {
                    Button(
        ...
        if(justify) {
            AlertDialog(
                onDismissRequest = { justify=false },
                title = { Text("Success") },
                text = { Text("Account successfully created!") },
                confirmButton = {
                    Button(
                        onClick = { justify=false }
                    ) {
                        Text("OK")
                    }
                }
